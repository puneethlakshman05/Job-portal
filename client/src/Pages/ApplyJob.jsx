...
const applyHandler = async() =>{
  ...
  return JobData ? (
    <>
    <Navbar/>
    <div className="min-h-screen flex flex-col py-10 container p-4 2xl:px-20 mx-auto">
      <div className="bg-white text-black rounded-lg w-full">
        <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-18 mb-6 bg-red-50 border border-red-300 rounded-xl">
          <div className="flex flex-col md:flex-row items-center ">
            <img className="h-12  bg-white rounded-lg p-2 mr-4 max-md:mb-4 border" src={JobData.companyId.image} alt=""/>
